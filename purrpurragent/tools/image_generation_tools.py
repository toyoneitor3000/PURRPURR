...
def generate_image(
    ...
    try:
        ...
        # Updated model name to a stable GA version if available or keep preview if that's what works
        # imagen-3.0-generate-001 is correct for preview.
        # Adding safety settings to avoid blocking on some prompts
        ...
        response = model.generate_images(
            ...
            # Adjusted safety settings to be less restrictive for creative work
...
def edit_image(
    ...
    try:
        ...
        return {
            "status": "error",
            "path": None,
            "error": f"Error editando imagen: {str(e)}"
        }
