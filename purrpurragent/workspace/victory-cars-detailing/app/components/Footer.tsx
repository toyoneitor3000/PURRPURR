      ...
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm font-light">
            <li><a href="#services" className="hover:text-brand-cyan transition-colors">Cerámico 9H</a></li>
            <li><a href="#services" className="hover:text-brand-cyan transition-colors">PPF Protection</a></li>
            <li><a href="#services" className="hover:text-brand-cyan transition-colors">Detailing Interior</a></li>
            <li><a href="#services" className="hover:text-brand-cyan transition-colors">Corrección de Pintura</a></li>
          </ul>
        </div>
