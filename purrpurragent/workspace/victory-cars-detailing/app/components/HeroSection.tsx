  ...
  return (
    <section className="relative h-screen min-h-[100vh] flex items-center justify-center overflow-hidden bg-brand-dark-blue">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center animate-fade-in">
        ...
        <div
          className="flex justify-center mb-8 md:mb-12 transition-opacity duration-500"
          style={{ opacity: logoOpacity }}
        >
          <Link href="/" className="block">
            <div className="relative h-24 w-80 md:h-[115px] md:w-96 lg:h-[134px] lg:w-[461px] animate-slide-down">
              <Image
                src="/logo.png"
