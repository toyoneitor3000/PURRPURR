...
const ServiceCard: React.FC<ServiceCardProps> = ({ title, description, imageUrl, price, promotion }) => {
  return (
    <div className="group relative bg-brand-mid-blue border border-white/5 rounded-2xl overflow-hidden hover:border-brand-cyan/50 transition-all duration-500 h-full flex flex-col hover:shadow-[0_0_30px_rgba(6,182,212,0.15)]">
      <div className="relative h-64 w-full overflow-hidden bg-brand-dark-blue">
        ...
        <Image 
          ...
          layout="fill" 
          objectFit="cover" 
          className="group-hover:scale-110 transition-transform duration-700 opacity-80 group-hover:opacity-100" 
        />
