...
const TestimonialsSection: React.FC = () => {
  return (
    <section className="py-24 bg-victory-black border-t border-white/5">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center text-white mb-16">Voces de la Excelencia</h2>
